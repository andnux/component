...
public class BitmapUtil {
    ...
    public static void setImageByResourcesId(Context context, ImageView imageView, int resourseId) {
        if (imageView == null)
            return;
        Bitmap bitmap = getBitmapFromResources(context, resourseId);
        if (bitmap == null)
            return;
    ...
    private static Bitmap getBitmapFromResources(Context context, int id) {
        Drawable drawable = ActivityCompat.getDrawable(context, id);
